...
def getopt(subparsers):
    parser = subparsers.add_parser(name = 'deinterleave', description = 'Deinterleaving a interleaved fastq file')
    ...
    parser.add_argument('-m','--min_length', help = 'Seq length cutoff (default: 10)', default=10, type=int)
