...
[![miniconda CI](https://github.com/wckdouglas/sequencing_tools/actions/workflows/miniconda_CI.yml/badge.svg)](https://github.com/wckdouglas/sequencing_tools/actions/workflows/miniconda_CI.yml)[![Documentation Status](https://readthedocs.org/projects/sequencing-tools/badge/?version=latest)](https://sequencing-tools.readthedocs.io/en/latest/?badge=latest)[![Docker Cloud Build Status](https://img.shields.io/docker/cloud/build/wckdouglas/sequencing_tools)](https://hub.docker.com/repository/docker/wckdouglas/sequencing_tools/general)
